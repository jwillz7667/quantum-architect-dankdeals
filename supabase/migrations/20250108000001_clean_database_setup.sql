...
INSERT INTO public.product_variants (id, product_id, name, weight_grams, price, inventory_count, is_active) VALUES
  ...
  ('pv_pf_quarter', '11111111-1111-1111-1111-111111111111', '1/4 oz (7g)', 7.0, 8000, 30, true),
  ('pv_pf_half', '11111111-1111-1111-1111-111111111111', '1/2 oz (14g)', 14.0, 15000, 20, true),
  ('pv_pf_ounce', '11111111-1111-1111-1111-111111111111', '1 oz (28g)', 28.0, 28000, 10, true),
  
  -- Rainbow Sherbert #11 variants (premium pricing)
  ('pv_rs_eighth', '22222222-2222-2222-2222-222222222222', '1/8 oz (3.5g)', 3.5, 4500, 40, true),
  ('pv_rs_quarter', '22222222-2222-2222-2222-222222222222', '1/4 oz (7g)', 7.0, 9000, 25, true),
  ('pv_rs_half', '22222222-2222-2222-2222-222222222222', '1/2 oz (14g)', 14.0, 16000, 15, true),
  ('pv_rs_ounce', '22222222-2222-2222-2222-222222222222', '1 oz (28g)', 28.0, 30000, 8, true),
  
  -- Runtz variants
  ('pv_rz_eighth', '33333333-3333-3333-3333-333333333333', '1/8 oz (3.5g)', 3.5, 4200, 45, true),
  ('pv_rz_quarter', '33333333-3333-3333-3333-333333333333', '1/4 oz (7g)', 7.0, 8500, 28, true),
  ('pv_rz_half', '33333333-3333-3333-3333-333333333333', '1/2 oz (14g)', 14.0, 15500, 18, true),
  ('pv_rz_ounce', '33333333-3333-3333-3333-333333333333', '1 oz (28g)', 28.0, 29000, 10, true),
  
  -- Wedding Cake variants
  ('pv_wc_eighth', '44444444-4444-4444-4444-444444444444', '1/8 oz (3.5g)', 3.5, 4200, 55, true),
  ('pv_wc_quarter', '44444444-4444-4444-4444-444444444444', '1/4 oz (7g)', 7.0, 8500, 35, true),
  ('pv_wc_half', '44444444-4444-4444-4444-444444444444', '1/2 oz (14g)', 14.0, 15500, 22, true),
  ('pv_wc_ounce', '44444444-4444-4444-4444-444444444444', '1 oz (28g)', 28.0, 29000, 12, true)
ON CONFLICT (id) DO UPDATE SET
