...
CREATE POLICY IF NOT EXISTS "Service role can manage email logs" ON public.email_logs
  FOR ALL USING (true);

CREATE POLICY IF NOT EXISTS "Service role can manage email bounces" ON public.email_bounces
  FOR ALL USING (true);
