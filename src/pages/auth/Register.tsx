...
export default function Register() {
  ...
  const [isOAuthLoading, setIsOAuthLoading] = useState<'google' | 'apple' | 'facebook' | null>(
    null
  );
  ...
  return (
    <>
      <SEOHead
        title="Register - DankDeals"
        description="Create your DankDeals account to start ordering premium cannabis products for delivery."
      />
        ...
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Join DankDeals to start ordering
            </CardDescription>
          </CardHeader>
          <CardContent>
            {/* OAuth Buttons */}
