...
const blogPosts = [
  {
    ...
    excerpt:
      'Learn about the differences between cannabis strains and how to choose the right one for your needs.',
    category: 'Education',
  ...
  },
  {
    ...
    excerpt:
      'Everything you need to know about dosing, timing, and enjoying cannabis edibles safely.',
    category: 'Guide',
  ...
  },
  {
    ...
    excerpt:
      'Best practices for storing cannabis flower, edibles, and concentrates to maintain quality.',
    category: 'Tips',
