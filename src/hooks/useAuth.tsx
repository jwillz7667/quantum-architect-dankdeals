...
interface AuthContextType {
  ...
  signUp: (email: string, password: string, firstName?: string, lastName?: string) => Promise<{ error: any; rateLimited?: boolean; lockedUntil?: number }>;
  signIn: (email: string, password: string) => Promise<{ error: any; rateLimited?: boolean; lockedUntil?: number }>;
